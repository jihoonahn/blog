...
public enum ElementDefinitions {
    ...
    public enum Figure: ElementDefinition { public static let wrapper = Node.figure }
    ...
    /// Definition for the `<script>` element.
    public enum Script: ElementDefinition { public static let wrapper = Node<HTML.BodyContext>.script }
}
...
/// A container component that's rendered using the `<figure>` element.
...
/// A container component that's rendered using the `<script>` element.
public typealias Script = ElementComponent<ElementDefinitions.Script>
...
/// valid HTML.
public struct List<Items: Sequence>: Component where Items: Sendable, Items.Element: Sendable {
...
/// Component used to render an inline SVG with custom elements.
public struct SVG: Component {
    ...
    public init(width: Int? = nil, height: Int? = nil, viewBox: String? = nil,
                @ComponentBuilder content: @escaping ContentProvider) {
        self.width = width
        self.height = height
    ...
    public var body: Component {
        var nodes: [Node<Any>] = [
            Node<Any>.attribute(.attribute(named: "xmlns", value: "http://www.w3.org/2000/svg"))
        ]
        
        if let width = width {
            nodes.append(.attribute(.attribute(named: "width", value: "\(width)")))
        }
        if let height = height {
            nodes.append(.attribute(.attribute(named: "height", value: "\(height)")))
        }
        if let viewBox = viewBox {
            nodes.append(.attribute(.attribute(named: "viewBox", value: viewBox)))
        }
        
        nodes.append(.component(content()))
        
        return Element(name: "svg", nodes: nodes)
    }
}

/// Component used to render an SVG `<path>` element.
public struct SVGPath: Component {
    public let d: String
    ...
    public var body: Component {
        Element(name: "path", nodes: [
            Node<Any>.attribute(.attribute(named: "d", value: d))
        ])
    }
}

/// Component used to render an SVG `<circle>` element.
public struct SVGCircle: Component {
    ...
    public var body: Component {
        Element(name: "circle", nodes: [
            Node<Any>.attribute(.attribute(named: "cx", value: "\(cx)")),
            Node<Any>.attribute(.attribute(named: "cy", value: "\(cy)")),
            Node<Any>.attribute(.attribute(named: "r", value: "\(r)"))
        ])
    }
}

/// Component used to render an SVG `<rect>` element.
public struct SVGRect: Component {
    public let x: Double
    public let y: Double
    ...
    public var body: Component {
        var nodes: [Node<Any>] = [
            Node<Any>.attribute(.attribute(named: "x", value: "\(x)")),
            Node<Any>.attribute(.attribute(named: "y", value: "\(y)")),
            Node<Any>.attribute(.attribute(named: "width", value: "\(width)")),
            Node<Any>.attribute(.attribute(named: "height", value: "\(height)"))
        ]
        
        if let rx = rx {
            nodes.append(.attribute(.attribute(named: "rx", value: "\(rx)")))
        }
        if let ry = ry {
            nodes.append(.attribute(.attribute(named: "ry", value: "\(ry)")))
        }
        
        return Element(name: "rect", nodes: nodes)
    }
}

/// Component used to render an SVG `<line>` element.
public struct SVGLine: Component {
    ...
    public var body: Component {
        Element(name: "line", nodes: [
            Node<Any>.attribute(.attribute(named: "x1", value: "\(x1)")),
            Node<Any>.attribute(.attribute(named: "y1", value: "\(y1)")),
            Node<Any>.attribute(.attribute(named: "x2", value: "\(x2)")),
            Node<Any>.attribute(.attribute(named: "y2", value: "\(y2)"))
        ])
    }
}

/// Component used to render an SVG `<g>` (group) element.
public struct SVGGroup: ComponentContainer {
    @ComponentBuilder public var content: ContentProvider
