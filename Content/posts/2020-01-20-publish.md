...
tags: Swift, Web, Home, ios, hig, human interface guide, rxswift, clean swift, rxcocoa, collectionview, uicollctionview
description:  Swift community is growing and so is the variety of tools that are being created. In this blog article we'll go through the creation of a blog using a static site generator Publish.
